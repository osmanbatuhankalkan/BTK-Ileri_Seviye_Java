package com.osman.hibernateDemo._004_Order_By_Islemleri;
...
public class Main {
    public static void main(String[] args) {
        ...
        try{
            ...
            //Bu yukarıdaki sorgumuzda sıralar fakat alfabetik yada büyükten kuçuğe olmaz !!!!

            //** ASC- Default olarak ASC gelir. Ascending a den z ye
            //List<City> cities = session.createQuery("from City c ORDER BY c.name ASC ").getResultList();

            // DESC- Descending Z den a ya
            ...
            //Burada İse ORDER BY ile alfabetik ve büyükten küçüğe sıralamalarımızı yapabiliriz.
            // form City ->> Sehirleri Seç,
            // c ORDER BY -->> Sırala,
            // c.name ->> isme göre
            // Yani Sehirleri seç isme göre sıralama demektir.
