package com.osman.hibernateDemo._001_Hibernate_Annotation_İle_Calismak;
...
public class City {
    ...
    ///****** İşte Bİz tamda bu şekilde City nesnesini, veri tabanındaki city tablosuyla MAP etmiş olduk
    public int getId() {
        return id;
    }
