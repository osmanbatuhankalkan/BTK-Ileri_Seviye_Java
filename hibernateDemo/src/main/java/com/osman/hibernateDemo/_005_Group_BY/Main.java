package com.osman.hibernateDemo._005_Group_BY;

import com.osman.hibernateDemo._005_Group_BY.City;
...
public class Main {
    public static void main(String[] args) {
        ...
        try{
            ...
            List<String> countryCodes = session.createQuery("Select c.countryCode from City c Group By c.countryCode ").getResultList();// Bütün Country Code ları tek bir sefer gelecek şeklde ayarladık.
            // Artık tablo değil kolon özelinde arama yapacağımız için STRİNG kullanacağız. City değil
